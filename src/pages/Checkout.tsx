    ...
    <Box>
      ...
      <Flex justify="center" minH={"100vh"}>
        <Flex justify="center" gap={10} wrap="wrap">
          ...
          <Box border="1px" borderColor="gray.200" h={"fit-content"} p={"5"}>
            <Text color="gray.600">Order Summary</Text>
            <Flex py={1} gap={10} color="gray.600">
              <Text>VAT</Text>
              <Text>Shs 0</Text>
            </Flex>
            <Flex pb={1} gap={10} color="gray.600">
              <Text>Total price</Text>
              <Text>Shs {totalPrice}</Text>
            </Flex>
            <Box>
              <Button onClick={HandleCheckout} bg={"#68D391"} color="#fff">
                Checkout
              </Button>
              <Text>
